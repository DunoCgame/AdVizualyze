  ...
  document.getElementById("container_area").innerHTML=`<div class="Containner-Área-de-imágenes"> 
          <div class="Containner-Área-de-imágenes-btn"> 
                  ...
                  <div class="container-video-inser">
                    <button class="video-btn ButtonAction icon-film">Video</button>
                    <div class="controles-video" style="display:none;">
                      <input type="text" id="videoId" placeholder="Inserte Id Video o URL">
                      <button id="saveBtn" onclick="InscrustarVideoNuevo('${Data_area_render_info[pos].id}')">Guardar</button>
                      <button id="SelectEnPCBtn" onclick="SeleccionrVideoenPC('${Data_area_render_info[pos].id}')">PC</button>
                      <button id="resetBtn" type="reset">Limpiar</button>
                    </div>
                  </div>
                  <!----------------------------------------->
                  <div class="container-delay">
                    ...
                    <div class="number-input">
                      ...
                      <input id="Delay" class="TimeDelay"  type="number" min="1" max="50" value="${Data_area_render_info[pos].delay/1000}">
  ...
  if(Data_area_render_info[pos].product.length>0){
          ...
          /*--------------------------------------------*/
            ...
            saveTextBtn.addEventListener('click', (e) => {
                ...
                const titleText = textEditorTitle.value.trim();
            ...
            /*---------------------------------------*/
                     ...
                     /* newDiv.innerHTML = ContainnerSquare.childNodes.length;*/
                      ...
                      newDiv.addEventListener('click', (e) => {
                        /*------------------------------------------------------*/
                        console.log(newDiv.querySelector(".resize-handle"))
                      ...
                      /*-------------Imagen Background------------------------------*/
                        ...
                        if (imageUrlValue=="") {
                            ...
                            // Lógica si NO está vacío
                            //console.log("El imageURl tiene un valor. ✅");
...
function Guardar(){
    ...
    /*--------------------------------------------------------------*/
        let Data = {
            ...
            "imageURL":"",
            "video":"",
            "delay":document.getElementsByClassName("TimeDelay")[0].value*1000,
            "product":[]
        }
